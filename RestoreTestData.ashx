<%@ WebHandler Language="C#" Class="PostHandler" %>	
	/*
	* RestoreTestData.ashx
	* Pavlo Kryvonis
	* 6-21-20116
	* Language:C# - ashx (Generic Handler)
	* Takes test data in CasinoAS1 and re-save them to restore to first possition.
	* Test data should be in the xml format used to test the reels.

	* This program is used by Ranorex for automated requests.
	*/
		...
		#region IHttpHandler Members
			...
			public void ProcessRequest (HttpContext context) 
			{
				...
				*/
				...
				{
					errs = errs + "\n'FileName' parameter is requried and missing.";
					validRequest = false;
				}
				string filePath = @"C:\MGS_Data\x86\VeyronGames\testdata\"+context.Request["FileName"];
				try
				{
